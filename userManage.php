...
<div class="container-fluid" style="margin-top:98px">
    ...
    <div class="row">
        <div class="card col-lg-12">
            <div class="card-body">
                <table id="tblusers" class="table-striped table-bordered col-md-12 text-center">
            ...
            <div class="modal-body">
                ...
                <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                    ...
                    <div class="form-group col-md-4">
                        <img src="/thesisnamin/img/person-<?php echo $Id; ?>.jpg" alt="Profile Photo"
                            width="100" height="100" onError="this.src ='/thesisnamin/img/profilePic.jpg'">
                        <form action="partials/_userManage.php" method="post">
                            <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
